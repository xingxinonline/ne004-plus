...
#define OFFLINE_IMAGE_BASE_ADDRESS  (0x80400000)

/* PSRAM Buffers (0x80400000+) - Compact Layout */
#define DISP_FRAME_SIZE             (DISP_IMAGE_WIDTH * DISP_IMAGE_HEIGHT * 2) // 40KB (0xA000)
#define DISP_ALPHA_SIZE             (DISP_IMAGE_WIDTH * DISP_IMAGE_HEIGHT * 1) // 20KB (0x5000)

#define DISP_RFRAME0_ADDR           (OFFLINE_IMAGE_BASE_ADDRESS)
#define DISP_RFRAME1_ADDR           (DISP_RFRAME0_ADDR + DISP_FRAME_SIZE)

#define DISP_RALPHA0_ADDR           (DISP_RFRAME1_ADDR + DISP_FRAME_SIZE)
#define DISP_RALPHA1_ADDR           (DISP_RALPHA0_ADDR + DISP_ALPHA_SIZE)

/* Write frames (for Camera) placed after Display buffers */
#define DISP_WFRAME0_ADDR           (DISP_RALPHA1_ADDR + DISP_ALPHA_SIZE)
#define DISP_WFRAME1_ADDR           (DISP_WFRAME0_ADDR + DISP_FRAME_SIZE)
