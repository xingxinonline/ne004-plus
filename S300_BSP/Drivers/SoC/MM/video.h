...
#define DISP_WFRAME1_ADDR           (0x44080000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 4));//0x80100000;
#define DISP_RFRAME0_ADDR           (0x44080000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 10));//0x44035000;//0x80200000
#define DISP_RFRAME1_ADDR           (0x44080000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 8));//0x44035000;//0x80300000;
#define DISP_RALPHA0_ADDR           (0x44080000 - (DISP_IMAGE_WIDTH * DISP_IMAGE_HEIGHT * 2));//0x44060000;//0x80250000;
