...
//     MicroPrintf("ProfileMemoryAndLatency start"); 
//     constexpr int kTensorArenaSize = 3000;
//     uint8_t tensor_arena[kTensorArenaSize];
//     constexpr int kNumResourceVariables = 24;
//     tflite::RecordingMicroAllocator *allocator(
//         tflite::RecordingMicroAllocator::Create(tensor_arena, kTensorArenaSize));
//     MicroPrintf("RecordingMicroAllocator *allocator");  // Print an empty new line
//     tflite::RecordingMicroInterpreter interpreter(
//         tflite::GetModel(g_hello_world_float_model_data), op_resolver, allocator,
//         tflite::MicroResourceVariables::Create(allocator, kNumResourceVariables),
//         &profiler);
//     MicroPrintf("RecordingMicroInterpreter interpreter");  // Print an empty new line
//     TF_LITE_ENSURE_STATUS(interpreter.AllocateTensors());
//     MicroPrintf("interpreter.AllocateTensors()");  // Print an empty new line
...
//     MicroPrintf("ProfileMemoryAndLatency end");
//     return kTfLiteOk;
// }
