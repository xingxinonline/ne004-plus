 ...
 *                          : -1 - Error
 */
int WebRtcAgc_AddMic(void* agcInst, int16_t* const* inMic, size_t num_bands,
                     size_t samples);
 ...
 *                          : -1 - Error
 */
int WebRtcAgc_VirtualMic(void* agcInst, int16_t* const* inMic, size_t num_bands,
                         size_t samples, int32_t micLevelIn,
                         int32_t* micLevelOut);
 ...
 *                          : -1 - Error
 */
int WebRtcAgc_Analyze(void* agcInst, const int16_t* const* inNear,
                      size_t num_bands, size_t samples, int32_t inMicLevel,
                      int32_t* outMicLevel, int16_t echo,
                      uint8_t* saturationWarning, int32_t gains[11]);
 ...
 *                          : -1 - Error
 */
int WebRtcAgc_Process(const void* agcInst, const int32_t gains[11],
                      const int16_t* const* in_near, size_t num_bands,
                      int16_t* const* out);
