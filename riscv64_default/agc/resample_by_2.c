/*
 * @Author       : panxinhao
 * @Date         : 2023-08-16 09:57:57
 * @LastEditors  : panxinhao
 * @LastEditTime : 2023-08-16 10:12:30
 * @FilePath     : \\testbench_base\\riscv64_default\\agc\\resample_by_2.c
 * @Description  :
 *
...
static __inline int32_t MUL_ACCUM_1(int32_t tbl_value, int32_t diff,
                                    int32_t state)
{
    int32_t result;
...
static __inline int32_t MUL_ACCUM_2(int32_t tbl_value, int32_t diff,
                                    int32_t state)
{
    int32_t result;
