 ...
 * @LastEditTime : 2023-08-16 10:13:20
 * @FilePath     : \\testbench_base\\riscv64_default\\agc\\division_operations.c
 * @Description  :
 *
...
WebRtcSpl_DivW32HiLow(int32_t num, int16_t den_hi, int16_t den_low)
{
    ...
    // tmpW32 = den * approx
    tmpW32 = (int32_t)0x7fffffffL -
             tmpW32;  // result in Q30 (tmpW32 = 2.0-(den*approx))
